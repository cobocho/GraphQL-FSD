...
exports.FindFirstDirectorOrThrowArgs = void 0;
...
let FindFirstDirectorOrThrowArgs = class FindFirstDirectorOrThrowArgs {
};
exports.FindFirstDirectorOrThrowArgs = FindFirstDirectorOrThrowArgs;
__decorate([
...
], FindFirstDirectorOrThrowArgs.prototype, "where", void 0);
__decorate([
    (0, graphql_1.Field)(() => [director_order_by_with_relation_input_1.DirectorOrderByWithRelationInput], { nullable: true }),
    __metadata("design:type", Array)
], FindFirstDirectorOrThrowArgs.prototype, "orderBy", void 0);
__decorate([
    (0, graphql_1.Field)(() => director_where_unique_input_1.DirectorWhereUniqueInput, { nullable: true }),
    __metadata("design:type", Object)
], FindFirstDirectorOrThrowArgs.prototype, "cursor", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_3.Int, { nullable: true }),
    __metadata("design:type", Number)
], FindFirstDirectorOrThrowArgs.prototype, "take", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_3.Int, { nullable: true }),
    __metadata("design:type", Number)
], FindFirstDirectorOrThrowArgs.prototype, "skip", void 0);
__decorate([
    (0, graphql_1.Field)(() => [director_scalar_field_enum_1.DirectorScalarFieldEnum], { nullable: true }),
    __metadata("design:type", Array)
], FindFirstDirectorOrThrowArgs.prototype, "distinct", void 0);
exports.FindFirstDirectorOrThrowArgs = FindFirstDirectorOrThrowArgs = __decorate([
    (0, graphql_2.ArgsType)()
], FindFirstDirectorOrThrowArgs);
//# sourceMappingURL=find-first-director-or-throw.args.js.map